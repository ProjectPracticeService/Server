package ru.mephi.pp.models.user//class Mentor (_id: Int, _role: com.example.PPSystem.com.example.PPSystem.user.user.Role, _username: String, _password: String, _email: String, _name: String, _sureName: String,
