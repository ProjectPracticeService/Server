...
open class User(_id: Int, _role: com.example.PPSystem.System.User.Role, _username: String, _password: String, _email: String,
                _name: String, _sureName: String, _status: String, _secondName: String, _telegramId: String){

    var id: Int
    var role: com.example.PPSystem.System.User.Role
    var username: String
    var password: String
    var email: String
    var name: String
